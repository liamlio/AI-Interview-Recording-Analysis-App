...
# From https://levelup.gitconnected.com/building-a-multi-page-app-with-streamlit-and-restricting-user-access-to-pages-using-aws-cognito-89a1fb5364a3
# ------------------------------------
...
# -----------------------------
login_link = f"{COGNITO_DOMAIN}/login?redirect_uri={APP_URI}&response_type=code&scope=email+openid&client_id={CLIENT_ID}"
